...
sos.settings.nMin                               = 3;        % see kzSolver.m
sos.settings.nMax                               = 3;        % see kzSolver.m

sos.settings.evanProp                           = 2;        % see kzSolver.m

sos.settings.kMin_rad_m                         = 0;        % see kzSolver.m               
%sos.settings.kMax_rad_m                        = 100;      % see kzSolver.m
...
sos.settings.fMax_Hz                            = 80000;    % see kzSolver.m           
sos.settings.fResolution_Hz                     = 5;        % see kzSolver.m  
sos.settings.fInitSteps                         = 20;       % see kzSolver.m
...
sos.settings.fExtraInitSteps_Hz                 = 80000;    % see kzSolver.m (e.g. [1035, 1498])
